...
export default function MemoryPage ({ allMemoriesData }) {
  return (
    <PostLayout>
      <Head>
        <title>{allMemoriesData.metaData.memory_date}: {allMemoriesData.metaData.title}</title>
      </Head>
      <article>
        <h1>{allMemoriesData.metaData.memory_date}: {allMemoriesData.metaData.title}</h1>
